...
//        RepoManager rm = RepoManager.cloneOrg("CourseSpecs.txt",HW + 5 + "-","EE551_Spring2019_homework5");
        ...
        if(args.length == 5) RepoManager.cloneOrg(args[1], args[2], args[3], args[4]);
     ...
     * optional, and should be the folder you want to load your files from, 
     * if it's not the default folder.
     * 
     * 
     */
    ...
    /**
     * Pass arguments to run from command line. First call clone, then call moss.
     * 
...
//        new TestManager(rm).updateAllTestFiles("C:/Users/Kayak/Documents/GitHub/python Class Stuff/EE551_Spring2019_homework5/tests");
